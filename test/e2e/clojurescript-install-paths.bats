...
@test "Build ClojureScript app with custom installPaths and installCommand" {
    ...
    # installPaths copied resources/public into $out, so shadow-cljs output
    # at resources/public/js should land at $out/public/js.
    [ -f result/public/js/main.js ]

    # The static asset shipped in resources/public/ should also be present.
    [ -f result/public/index.html ]
